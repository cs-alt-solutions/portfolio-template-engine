    ...
    return (
      <section className="w-full max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 items-start p-8">
        ...
        <div className="w-full lg:w-2/3 space-y-12">
          {imageUrl && (
            <div className={`w-full aspect-video ${shapeRadius} overflow-hidden shadow-xl grayscale hover:grayscale-0 transition-all duration-700`}>
  ...
  if (aboutLayout === 'card' || aboutLayout === 'glass' || aboutLayout === 'glass-card' || aboutLayout === 'glass_card') {
    return (
      <section className={`w-full max-w-6xl mx-auto relative ${shapeRadius} overflow-hidden p-8 md:p-16 lg:p-24 shadow-2xl`}>
        ...
        <div className={`relative z-10 w-full max-w-3xl mx-auto bg-white/5 backdrop-blur-xl border border-white/10 p-10 md:p-16 ${shapeRadius} shadow-inner text-center`}>
  ...
  return (
    <section className="w-full max-w-7xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-center">
        <div className={`flex flex-col justify-center bg-white dark:bg-zinc-900 shadow-xl border border-zinc-100 dark:border-zinc-800 p-8 md:p-12 ${shapeRadius}`}>
